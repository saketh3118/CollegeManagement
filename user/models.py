...
class Semester(models.Model):
    ...
    c1=models.CharField(max_length=10,default=0)
    EC=models.IntegerField()
    c2=models.CharField(max_length=10,default=0)
    BEEE=models.IntegerField()
    c3=models.CharField(max_length=10,default=0)
    PPS=models.IntegerField()
    c4=models.CharField(max_length=10,default=0)
    PPS_LAB=models.IntegerField(default=0)
    c5=models.CharField(max_length=10,default=0)
    EC_LAB=models.IntegerField()
    c6=models.CharField(max_length=10,default=0)
    ...
    c10=models.CharField(max_length=10,default=0)
    SCP=models.IntegerField(default=0)
    c11=models.CharField(max_length=10,default=0)
    PYTHON=models.IntegerField(default=0)
    c12=models.CharField(max_length=10,default=0)
    EG=models.IntegerField(default=0)
    c13=models.CharField(max_length=10,default=0)
    ENG_LAB=models.IntegerField(default=0)
    c14=models.CharField(max_length=10,default=0)
    ...
    c18=models.CharField(max_length=10,default=0)
    DS=models.IntegerField(default=0)
    c19=models.CharField(max_length=10,default=0)
    JAVA=models.IntegerField(default=0)
    c20=models.CharField(max_length=10,default=0)
    OS=models.IntegerField(default=0)
    c21=models.CharField(max_length=10,default=0)
    DS_LAB=models.IntegerField(default=0)
    c22=models.CharField(max_length=10,default=0)
    JAVA_LAB=models.IntegerField(default=0)
    c23=models.CharField(max_length=10,default=0)
    ...
    c27=models.CharField(max_length=10,default=0)
    WT=models.IntegerField(default=0)
    c28=models.CharField(max_length=10,default=0)
    DAA=models.IntegerField(default=0)
    c29=models.CharField(max_length=10,default=0)
    CC=models.IntegerField(default=0)
    c30=models.CharField(max_length=10,default=0)
    DBMS_LAB=models.IntegerField(default=0)
    c31=models.CharField(max_length=10,default=0)
    WT_LAB=models.IntegerField(default=0)
    c32=models.CharField(max_length=10,default=0)
